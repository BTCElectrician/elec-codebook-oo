...
5. Record edition, content ranges, printed-page offset, backend, and embedding choice.
...
10. After indexing, run a representative `search` and verify source wording and both page fields.
